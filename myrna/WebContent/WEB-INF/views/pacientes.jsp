            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- BEGIN PAGE TITLE-->
						  ...
						  <!--
						  <h3 class="page-title"> Fixed Sidebar
                                ...
                                <div class="portlet-body table-both-scroll">
                                    ...
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button id="sample_editable_1_new" class="btn sbold green"> Nuevo
                                                        <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                                <div class="btn-group">
                                                    <button id="sample_editable_1_new" class="btn sbold green"> Modificar
                                                        <i class="fa fa-edit"></i>
                                                    </button>
                                                </div>
                                                <div class="btn-group">
                                                    <button id="sample_editable_1_new" class="btn sbold green"> Borrar
                                    ...
                                    <table class="table table-striped table-bordered table-hover selectable order-column" id="sample_3">
										<thead>
                                            <tr>
                                                <th>Nombre</th>
                                                <th>Apellidos</th>
