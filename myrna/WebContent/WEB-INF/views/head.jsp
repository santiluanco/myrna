    ...
    <head>
        ...
        <title>Ana Belen Alba | Clinica Dental</title>
        
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="Aplicacion Clinica Dental" name="description" />
        <meta content="Santiago Gonzalezs Alvarez" name="author" />
        ...
        <link href='resources/assets/global/plugins/bootstrap-select/css/bootstrap-select.min.css' rel="stylesheet" type="text/css" />
